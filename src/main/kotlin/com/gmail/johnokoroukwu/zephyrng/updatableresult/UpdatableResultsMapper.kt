...
import com.gmail.johnokoroukwu.zephyrng.updatableresult.merge.MergeStrategyDelegator
...
class UpdatableResultsMapper(
    private val zephyrTestResultToDataSetMapper: IZephyrTestResultToDataSetMapper = ZephyrResultToDataSetMapperImpl,
