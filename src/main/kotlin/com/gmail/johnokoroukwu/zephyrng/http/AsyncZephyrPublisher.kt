...
import com.gmail.johnokoroukwu.zephyrng.http.createtestcycle.CreateTestCycleRequestSender
import com.gmail.johnokoroukwu.zephyrng.http.detailedreport.GetDetailedReportSender
import com.gmail.johnokoroukwu.zephyrng.http.testcycleupdate.UpdateTestCycleRequestSender
import com.gmail.johnokoroukwu.zephyrng.http.testresultstatus.TestResultStatus
import com.gmail.johnokoroukwu.zephyrng.http.testresultupdate.TestResultUpdater
import com.gmail.johnokoroukwu.zephyrng.http.testscriptresult.UpdateTestScriptResultsRequestSender
...
class AsyncZephyrPublisher(
    ...
    fun submitResults(
        ...
        if (testNgZephyrSuites.isNotEmpty()) {
            logger.info { "Publishing TestNG test results to Zephyr project" }
            measureTimeMillis {
                runBlocking {
