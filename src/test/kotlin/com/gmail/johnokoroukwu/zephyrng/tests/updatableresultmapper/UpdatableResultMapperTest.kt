package com.gmail.johnokoroukwu.zephyrng.tests.updatableresultmapper
...
import com.gmail.johnokoroukwu.zephyrng.updatableresult.IZephyrTestResultToDataSetMapper
import com.gmail.johnokoroukwu.zephyrng.updatableresult.UpdatableResultsMapper
import com.gmail.johnokoroukwu.zephyrng.updatableresult.merge.MergeResult
import com.gmail.johnokoroukwu.zephyrng.updatableresult.merge.ResultMergeStrategy
...
class UpdatableResultMapperTest {
    companion object {
        ...
        private val testCaseWithTestNgResults = TestCaseWithTestNgResults(
            id = 1,
            key = "test-case-key",
            startTime = 1L,
            endTime = 2L,
        ...
        private val testResultToDataSetMapperMock: IZephyrTestResultToDataSetMapper = mockk()
    ...
    fun `should return empty result pair`() {
        ...
        val testCaseWithTestNgResultsMockOne = mockk<TestCaseWithTestNgResults> {
            every { id } returns 4
            every { key } returns "test-key-one"
        }
        val testCaseWithTestNgResultsMockTwo = mockk<TestCaseWithTestNgResults> {
            every { id } returns 5
