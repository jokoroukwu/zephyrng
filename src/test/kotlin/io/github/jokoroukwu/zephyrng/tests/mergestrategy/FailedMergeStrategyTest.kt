package io.github.jokoroukwu.zephyrng.tests.mergestrategy
...
import io.github.jokoroukwu.zephyrng.updatableresult.merge.FailedResultMergeStrategy
...
class FailedMergeStrategyTest {
    ...
    fun `should return expected comment row`(
        ...
        testNgResults: io.github.jokoroukwu.zephyrng.TestNgDataSetResult,
    ...
    private fun testScriptResultsTestProvider(): Array<Array<Any>> {
        ...
        val allStatusTestNgDataSet =
            io.github.jokoroukwu.zephyrng.TestNgDataSetResult(startTime, endTime, 0, false, 1, message)
        ...
        val noBlockedStatusTestNgDataSetResult =
            io.github.jokoroukwu.zephyrng.TestNgDataSetResult(startTime, endTime, 0, false, 2, message)
        ...
        val noPassedStatusTestNgDataSetResult =
            io.github.jokoroukwu.zephyrng.TestNgDataSetResult(startTime, endTime, 0, false, 0, message)
