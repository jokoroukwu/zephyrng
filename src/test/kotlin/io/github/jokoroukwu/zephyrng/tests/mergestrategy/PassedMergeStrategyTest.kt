...
import io.github.jokoroukwu.zephyrng.updatableresult.merge.PassedResultMergeStrategy
...
class PassedMergeStrategyTest {
    ...
    private val testNgDataSetResult = io.github.jokoroukwu.zephyrng.TestNgDataSetResult(20L, 30, dataSetIndex, true)
