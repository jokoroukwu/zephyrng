package io.github.jokoroukwu.zephyrng.tests.updatableresultmapper
...
import io.github.jokoroukwu.zephyrng.updatableresult.UpdatableResultsMapper
import io.github.jokoroukwu.zephyrng.updatableresult.ZephyrTestResultToDataSetMapper
import io.github.jokoroukwu.zephyrng.updatableresult.merge.MergeResult
...
class UpdatableResultMapperTest {
    companion object {
        ...
        private val testCaseWithTestNgResults = io.github.jokoroukwu.zephyrng.TestCaseWithTestNgResults(
            id = 1,
            key = "test-case-key",
            startTime = 1L,
            endTime = 2L,
            listOf(
                io.github.jokoroukwu.zephyrng.TestNgDataSetResult(
                    index = 0,
                    startTime = 1L,
                    endTime = 2L,
                    isSuccess = true
    ...
    fun `should return empty result pair`() {
        ...
        val testCaseWithTestNgResultsMockOne = mockk<io.github.jokoroukwu.zephyrng.TestCaseWithTestNgResults> {
            every { id } returns 4
            every { key } returns "test-key-one"
        }
        val testCaseWithTestNgResultsMockTwo = mockk<io.github.jokoroukwu.zephyrng.TestCaseWithTestNgResults> {
            every { id } returns 5
